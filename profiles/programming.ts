...
import { createHyperSubLayers, app, claudeCmd, vimCmd, cmdSublayer, whenMode } from "../utils";

// Programming mode: active while the `programming` variable is 1.
// Gated Hyper sublayers that replace the Normal-mode ones (git, Claude, tmux,
// vim commands, Godot). Assembled into the single unified profile in normal.ts.
export const programmingRules: KarabinerRules[] = createHyperSubLayers({
